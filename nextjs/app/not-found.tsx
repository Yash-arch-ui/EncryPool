  ...
  return (
    <div className="flex items-center h-full flex-1 justify-center bg-card">
      <div className="text-center">
        ...
        <Link href="/" className="inline-block rounded-full bg-primary px-6 py-3 font-mono text-sm font-bold text-primary-foreground shadow-[0_0_36px_color-mix(in_srgb,var(--primary)_34%,transparent)] transition-transform hover:-translate-y-0.5">
          Go Home
        </Link>
      </div>
    </div>
